// Remove this circular import line
...
class _StudentCoursesScreenState extends State<StudentCoursesScreen> {
  ...
  Future<void> _loadCourses() async {
    ...
    try {
      ...
      print('Loading courses for student ID: $studentId (type: ${studentId.runtimeType})');
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                // Navigate to course detail screen using named route
                                Navigator.pushNamed(
                                  context,
                                  '/courseDetail',
                                  arguments: course,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () => _unenrollFromCourse(course['id']),
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          // TODO: Navigate to course attendance screen
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            const SnackBar(
